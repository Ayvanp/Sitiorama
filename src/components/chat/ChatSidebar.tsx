...
export default function ChatSidebar() {
  return (
    <aside className="w-65 border-r border-gray-700 flex flex-col">
      ...
      <div className="mt-auto p-4 flex items-center justify-between">
        <button className="rounded-full h-9 w-9 flex items-center justify-center"></button>
        <button className="rounded-full h-9 w-9 flex items-center justify-center"></button>
        <button className="rounded-full h-9 w-9 flex items-center justify-center"></button>
        <button className="rounded-full bg-gray-800 border border-gray-700 hover:bg-gray-700 text-gray-300 px-4 py-2 w-500 h-17">
          Nuevo Chat
        </button>
      </div>
    </aside>
